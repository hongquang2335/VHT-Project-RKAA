...
class KnowledgeStore:
    ...
    def __init__(self, path: str | Path) -> None:
        ...
        if self.path.exists():
            ...
            self._data = {"schema_version": self.SCHEMA_VERSION, "records": {}}
    ...
    def approve(self, kpi_name: str, version: int) -> dict[str, Any]:
        versions = self._data["records"].get(kpi_name, [])
    ...
    def import_records(self, records: Iterable[dict[str, Any]]) -> list[dict[str, Any]]:
